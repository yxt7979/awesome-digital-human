...
## 3D Human Avatar Generation (用文字生成或结合diffusion,StyleGAN)
...
## Clothed Human Digitalization (Animatable / realtime)
...
CVPR 2023. [[PDF](https://arxiv.org/abs/2304.03903)] 
...
## Clothed Human Digitalization (can not Animatable)
